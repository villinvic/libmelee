...
BLASTZONES_X = {
    enums.Stage.BATTLEFIELD : 224,
    enums.Stage.FINAL_DESTINATION : 246,
    enums.Stage.DREAMLAND : 255,
    enums.Stage.FOUNTAIN_OF_DREAMS : 198.75,
    enums.Stage.POKEMON_STADIUM : 230,
    enums.Stage.YOSHIS_STORY : 173.6,
}

BLASTZONES_Y = {
    enums.Stage.BATTLEFIELD : (200, -108.8),
    enums.Stage.FINAL_DESTINATION : (188, -140),
    enums.Stage.DREAMLAND : (250, -123),
    enums.Stage.FOUNTAIN_OF_DREAMS : (202.5, -146.25),
    enums.Stage.POKEMON_STADIUM : (180, -111),
    enums.Stage.YOSHIS_STORY : (168, -91)
}
